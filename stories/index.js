...
GameoverStory.add('standard', () => <DefaultGameover full={boolean('Like', false)} dictionary={dictionary} show={boolean('Show', true)} label={'default'} title={'Default'} score={200} rank={6} game_info={game_info} />)
GameoverStory.add('gameasy', () => <GameasyGameover full={boolean('Like', false)} dictionary={dictionary} show={boolean('Show', true)} label={'gameasy'} title={'Gameasy'} score={200} rank={6} game_info={game_info}/>);
GameoverStory.add('zain', () => <ZainGameover full={boolean('Like', false)} dictionary={dictionary} show={boolean('Show', true)} label={'zain'} title={'Zain'} score={200} rank={6} game_info={game_info}/>);
