...
export const FB_SDK_VERSION = '2.4';
export const FB_SDK_URL = 'connect.facebook.net/en_US/all.js';
...
export const MOA_API_LEADERBOARD_POST_SCORE = 'http://resources2.buongiorno.com/lapis/apps/leaderboard.postScore'; // ?real_customer_id=xx_gameasy&lang=en&white_label=xx_bandai&main_domain=http://bandai2.gameasy.com/ww/&country=xx&fw=gameasy&vh=ww.bandai.gameasy.com'
